...
class Upload_Helper {
    ...
    /**
     * Constructor method. You can define the file, uploads folder, 
     * new file name and the language. Define too the default messages
     */
    ...
    /**
     * Checks whether to overwrite files with the same name. 
     * If not, creates name incremented ($name, $name_1, $name_2, $name_n)
     */

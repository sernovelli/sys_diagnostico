...
require_once 'models/UsuarioClienteModel.php';
/**
 * 
 ...
 * Arquivo - UsuarioClienteController.php
 * 
...
class UsuarioClienteController {
	...
	private $controle = "UsuarioCliente";
	...
	*/	
	public function listarAction() {
		...
		$vetor = $objeto->_list($_REQUEST['id'], $_REQUEST['usuario'], $_REQUEST['cliente']);

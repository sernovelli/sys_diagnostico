...
/**
 * Classe para excluir fotos publicadas a 90 ou mais dias
 */
 
 class ExcluiFotosModel extends PersistModelAbstract {
...
// 	
	...
	/**
	 * Consulta as fotos inativas com base na data de vencimento
	 */
	public function listaFotosExclusao() {
		
		$vetor = array();
		
		$query = "SELECT * 
				  FROM foto 
				 WHERE dataExclusao = '".$this->hoje."'
				   AND foto.fotoStatus = '2'";
	   ...
	   public function excluiFoto($idFoto) {
	   	 ...
	   	 $query = "DELETE FROM foto 
	   	 		  WHERE foto.pk_foto = ".$idFoto."
	   	 		    AND foto.fotoStatus = '2'
	   	 		    AND foto.dataExclusao = '".$this->hoje."'";
